 ...
 * @author Giuseppe
 */
public class FinestraRecensioneLibro2 extends javax.swing.JDialog {

    /**
     * Creates new form FinestraRecensioneLibro
     */
    public FinestraRecensioneLibro2(java.awt.Frame parent, boolean modal/*, int id, String isbn*/) {
        super(parent, modal);
    ...
    public ResultSet resultSetAggiorna() throws SQLException {
        return DBConnection.visualizzaLibriDisponibili();//DBConnection.visualizzaUtenti();
    }
