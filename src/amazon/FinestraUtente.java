...
public class FinestraUtente extends EditForm {
    ...
    protected void cleanContents() {
        ...
        tMail.setText("");
        tPass.setText("");
        tCell.setDocument(new JTextFieldLimit(15));
    }
    ...
    private void eseguiOk()
    {
        ...
        try {
            if (mode == ADDN)
                ...
                DBConnection.aggiornaUtente(Integer.parseInt(tID.getText()), tNome.getText(), tCognome.getText(), tMail.getText(), tPass.getText(), tCell.getText());
            chiudiFinestra();
        }
